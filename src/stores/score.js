...
export const useScoreStore = defineStore('score', {
    ...
    getters: {
        ...
        levelName(state) {
            const levels = [
                { min: 0, max: 10000, name: 'Bronze' },
                { min: 10000, max: 50000, name: 'Silver' },
                { min: 50000, max: 100000, name: 'Gold' },
                { min: 100000, max: 250000, name: 'Platinum' },
                { min: 250000, max: 500000, name: '2-nd Platinum' },
                { min: 500000, max: 1000000, name: 'Diamond' },
            ]
